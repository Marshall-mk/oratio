...
class Challenge(Base):
    ...
    category: Mapped[str] = mapped_column(Text)  # thought | structure | speaking | scenario | coach
    subcategory: Mapped[str | None] = mapped_column(Text)  # grouping within a category
    ...
    generated_for: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True))
    gen_topic: Mapped[str | None] = mapped_column(Text)
